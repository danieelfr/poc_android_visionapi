package danieeelfr.pocs.ciandt.pocs.vision;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p.setMessage("Aguardando Google Cloud Vision API...");
        p.setMessage("Reconhecimento de imagens");
        p.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        p.setIcon(R.drawable.common_google_signin_btn_icon_light_normal);
    }
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MainActivity.this, "Permissão inválida!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_GALLERY_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Nenhuma conta selecionada.", Toast.LENGTH_SHORT)
                        .show();
            }
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Falha na autorização", Toast.LENGTH_SHORT)
                        .show();
            }
        }
    }
    ...
    public void uploadImage(Uri uri) {
        if (uri != null) {
            ...
            Log.e(LOG_TAG, "Houve um problema no carregamento da imagem.");
        }
    }
    ...
    private void callCloudVision(final Bitmap bitmap) throws IOException {
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected String doInBackground(Object... params) {
                ...
                return "Houve uma falha ao consumir a Cloud Vision API.";
            }
